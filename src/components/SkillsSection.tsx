      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-8">
            {Object.entries(skills).map(([category, skillList], index) => <div key={category} className="card-glow bg-card p-6 rounded-lg border border-border hover:border-primary/50 transition-all duration-300" style={{
